    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            <tr v-for="project in projects.data" :key="project.id"  class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                    <img class="w-24 h-auto rounded-full" :src="project.image" />
                </td>
                <td class="px-6 py-4">
                    {{project.project_url}}
                </td>
                <td class="px-6 py-4">
                    <Link :href="route('projects.edit', project.id)" class="font-medium text-blue-500 hover:text-blue-700 mr-12">Edit</Link>
